            ...
            <div className="flex flex-col md:flex-row gap-12">
                ...
                <div className="w-full md:w-1/3 flex justify-center md:block">
                    <div className="p-4 h-full bg-white/50 rounded-2xl shadow-sm border border-gray-100 max-w-sm">
                        <img
                            src="https://upload.wikimedia.org/wikipedia/en/7/7e/Gone_Girl_%28Flynn_novel%29.jpg"
                            alt="Book Cover"
                ...
                <div className="w-full md:w-2/3 flex flex-col gap-6">
                    ...
                    {/* Title and Author */}
                    <div>
                        <h1 className="text-4xl font-bold text-gray-900 mb-2">Gone Girl</h1>
                        <p className="text-lg text-gray-600">by Gillian Flynn</p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-y-6 gap-x-12 p-6 bg-white border border-gray-200 rounded-xl mt-2 w-full lg:w-4/5">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-2 text-gray-600">
                                ...
                                <span className="font-medium text-black">978-0307588371</span>
                            </div>
                        </div>
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-2 text-gray-600">
                                ...
                                <span className="font-medium text-black">2012</span>
                            </div>
                        </div>
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-2 text-gray-600">
                                ...
                                <span className="font-medium text-black">432</span>
                            </div>
                        </div>
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-2 text-gray-600">
                                ...
                                <span className="font-medium text-black">3 copies</span>
                            </div>
                        </div>
                    </div>
